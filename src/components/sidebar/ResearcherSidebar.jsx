    ...
    <div className="relative flex mt-20">
      ...
      <div
        className={`transition-all duration-300 ease-in-out mt-16 sm:mt-20 ${
          isOpen ? "w-64" : "w-0"
        } bg-blue-800 text-white fixed inset-y-0 left-0 z-30 overflow-hidden transform`}
        style={{
      ...
      >
        {/* Sidebar Header */}
        <div className="bg-blue-900 text-white text-center py-4 px-6 text-xl font-semibold">
          Menu
        </div>
